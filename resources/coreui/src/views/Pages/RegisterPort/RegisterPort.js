...
class RegisterPort extends Component {
  constructor(){
    super()
    this.state = {
      username: '',
  ...
  onSubmit(e){
    ...
    // validate check if theres no error in the form 
      ...
      axios
        .post('api/port/register', { user: encrypted_user_data }, {
          ...
          <Row className="justify-content-center">
            <Col md="9" lg="7" xl="6">
              <div className="mb-3 mx-auto text-center"  style={{marginTop: "100px"}}>
                ...
                <h5 className="text-center" style={{marginTop: "15px"}}>Ports</h5>
              </div>
              <Card className="mx-4">
                <CardBody className="p-4">
                  ...
                  <br></br><p>Already have an account? <a href="/#/login_port">sign in</a></p>
                </CardBody>
