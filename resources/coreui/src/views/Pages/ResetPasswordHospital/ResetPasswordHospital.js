...
class ResetPasswordHospital extends Component {
  constructor(props) {
    super(props)
    this.state = {
      // first_name: '',
  ...
  onSubmit(e){
    ...
    // validate check if theres no error in the form 
      ...
      axios
        .post('api/hospital/resetPassword', { user: encrypted_user_data }, {
...
export default ResetPasswordHospital;
