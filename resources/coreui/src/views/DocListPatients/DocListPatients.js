...
class DocListPatients extends Component {
  constructor(props) {
    super(props);
    // ////////////////MODAL
  ...
  uploadSendFile(){
    const url = '/api/doc/patient/chat/file/send/'+this.state.patient_id+'/'+this.state.id+`?token=${this.state.token}`;
...
export default DocListPatients;
