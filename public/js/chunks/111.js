...
/***/ "./resources/coreui/src/views/PortAccount/PortAccount.js":
/*!***************************************************************!*\
  !*** ./resources/coreui/src/views/PortAccount/PortAccount.js ***!
  \***************************************************************/
...
var PortAccount = /*#__PURE__*/function (_Component) {
  _inherits(PortAccount, _Component);

  var _super = _createSuper(PortAccount);

  function PortAccount(props) {
    var _this$state;

    var _this;

    _classCallCheck(this, PortAccount);
    ...
    _this.state = (_this$state = {
      ...
      currentPage2: '',
      status: '1'
    }, _defineProperty(_this$state, "status", ""), _defineProperty(_this$state, "created_at", localStorage["appState"] ? JSON.parse(localStorage["appState"]).user.created_at : ""), _defineProperty(_this$state, "user_type", localStorage["appState"] ? JSON.parse(localStorage["appState"]).user.user_type : ""), _defineProperty(_this$state, "fadeIn", true), _defineProperty(_this$state, "timeout", 300), _this$state);
    _this.handlePageChange = _this.handlePageChange.bind(_assertThisInitialized(_this));
    return _this;
  } // fetch data from db


  _createClass(PortAccount, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var _this2 = this;

      axios__WEBPACK_IMPORTED_MODULE_3___default.a.get("/api/port/account/" + this.state.id + "?token=".concat(this.state.token)).then(function (response) {
        return response;
      }).then(function (json) {
    ...
    value: function handlePageChange(pageNumber) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default.a.get("/api/port/account/" + this.state.id + "?token=".concat(this.state.token, "&page=") + pageNumber).then(function (response) {
        return response;
      }).then(function (json) {
        if (json.data.success) {
          _this3.setState({
...
/* harmony default export */ __webpack_exports__["default"] = (PortAccount);
