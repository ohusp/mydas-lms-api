  ...
  _createClass(PatientListHospitals, [{
    ...
    value: function getMessages1(doc_id) {
      ...
      this.interval = setInterval(function () {
        return _this7.getMessages2(doc_id);
      }, 5000);
    } // get messages
    ...
    value: function viewDoctor(doctor_id, name) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_4___default.a.get("/api/patient/doctors/get/" + doctor_id + '/' + this.state.id + "?token=".concat(this.state.token)).then(function (response) {
        ...
        if (json.data.success) {
          ...
          }, _this10.toggleViewDoctor(doctor_id, name));
        } else {
          _this10.setState({
    ...
    value: function viewAppointments() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_4___default.a.get("/api/patient/doc_appointments/get/" + this.state.id + "?token=".concat(this.state.token)).then(function (response) {
        ...
        if (json.data.success) {
          ...
          }, _this13.toggleViewAppointments());
        } else {}
      })["catch"](function (error) {
        // redirect user to previous page if user does not have autorization to the page
        // hashHistory.push('/premontessori');
    ...
    value: function handlePageChangeAppointments(pageNumber) {
      var _this14 = this; // this.setState({activePage: pageNumber});
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        onClick: function onClick() {
          return _this15.viewAppointments();
        }
      ...
      this.state.hospitals_list.map(function (hospital) {
        if (hospital.status == 1) {
          _this15.state.status = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_11__["Badge"], {
            color: "success"
          }, "Completed");
        } else {
          _this15.state.status = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_11__["Badge"], {
        ...
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", {
          ...
          size: "sm",
          onClick: function onClick() {
            return _this15.getDoctors(hospital.id, hospital.name);
          },
        ...
        toggle: function toggle() {
          return _this15.toggleViewDoctors("close", "close");
        }
      ...
      this.state.doctors_list.map(function (doctor) {
        ...
        if (doctor.gender == "0") {
          _this15.state.gender = "Not specified";
        }

        if (doctor.gender == "1") {
          _this15.state.gender = "Male";
        }

        if (doctor.gender == "2") {
          _this15.state.gender = "Female";
        }

        if (doctor.gender == "3") {
          _this15.state.gender = "Prefer not to say";
        }

        if (doctor.gender == "4") {
          _this15.state.gender = doctor.gender_others;
        }
        ...
        toggle: function toggle() {
          return _this15.toggleViewDoctor("close", "close");
        }
        ...
        toggle: function toggle() {
          return _this15.toggleViewAppointments("close", "close");
        }
      ...
      this.state.appointments_list.map(function (appointment) {
        ...
        if (appointment.status == 1) {
          ...
          _this15.state.chatBtn = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_11__["Button"], {
            size: "sm",
            onClick: function onClick() {
              return _this15.togglePrimary(appointment.doc_id, appointment.name);
            },
            className: "btn-facebook btn-brand icon mr-1 mb-1"
          }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("i", {
        ...
        toggle: function toggle() {
          return _this15.toggleMakePayment("close", "close");
        }
        ...
        onSuccess: function onSuccess(details, data) {
          _this15.state.billing_amount_currency = details.purchase_units[0].amount.currency_code;
          _this15.state.billing_amount_value = details.purchase_units[0].amount.value;
          _this15.state.billing_orderID = data.orderID;
          _this15.state.billing_payerID = data.payerID;
          _this15.state.billing_email_address = details.payer.email_address;
          _this15.state.billing_name = details.payer.name.given_name + " " + details.payer.name.surname; // console.log(details);
          // console.log(data);
          // console.log(details.purchase_units[0].amount.currency_code)
          // console.log(details.purchase_units[0].amount.value)

          return _this15.onSubmitBookAppointment2();
        },
